...
export function Header({ isLoading, selectedModel, stats }) {
  ...
  return (
    <div className='relative'>
      {/* Top Info Bar */}
      <div className='bg-gradient-to-r from-slate-50 to-slate-100/80 border-b border-slate-200/50 max-w-[85%] mx-auto py-1.5 px-6'>
        <div className='container mx-auto flex items-center justify-between text-xs'>
          {/* Left: Creator Name */}
          <div className='flex items-center gap-1.5'>
            <span className='text-slate-500'>Built by</span>
            <span className='font-medium text-slate-700'>Sanjeev Saniel</span>
          </div>
          ...
          <div className='flex items-center gap-3'>
            <Link
              ...
              className='flex items-center gap-1 text-slate-500 hover:text-black transition-colors group'>
              <FaXTwitter className='w-3 h-3 group-hover:scale-110 transition-transform' />
            </Link>

            <Link
              href='https://instagram.com/SanjeevSaniel'
              target='_blank'
              rel='noopener noreferrer'
              className='flex items-center gap-1 text-slate-500 hover:text-pink-500 transition-colors group'>
              <FaInstagram className='w-3 h-3 group-hover:scale-110 transition-transform' />
            </Link>

            <Link
              href='https://linkedin.com/in/SanjeevSaniel'
              target='_blank'
              rel='noopener noreferrer'
              className='flex items-center gap-1 text-slate-500 hover:text-blue-600 transition-colors group'>
              <FaLinkedin className='w-3 h-3 group-hover:scale-110 transition-transform' />
            </Link>

            <Link
              href='https://github.com/SanjeevSaniel/custom-tokenizer'
              target='_blank'
              rel='noopener noreferrer'
              className='flex items-center gap-1 text-slate-500 hover:text-gray-900 transition-colors group'>
              <FaGithub className='w-3 h-3 group-hover:scale-110 transition-transform' />
            </Link>
          </div>
        </div>
      </div>
